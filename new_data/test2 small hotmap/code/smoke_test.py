...
from protocol import COMMON_ORIGIN_LOOKBACK, HIDDEN_SIZES, PREDICT_STEPS
from train_fine_cell import ControlledGRU
...
def main() -> None:
    ...
    for hidden_size in HIDDEN_SIZES:
        ...
        history = torch.randn(4, COMMON_ORIGIN_LOOKBACK, 54)

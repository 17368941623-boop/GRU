...
PREDICT_STEPS = 30
TARGET_COLUMN = "Thv"
LABEL_COLUMN = "Future_Thv_30step"
...
def protocol_payload() -> dict[str, Any]:
    return {
        ...
        "target": "Delta Thv(t+30)=Thv(t+30)-Thv(t), restored to absolute Thv for metrics",
        ...
        "known_future_control_input": "all enabled raw valve commands u(t)..u(t+29)",
        "engineered_features_used": False,
        "pcmci_used": False,
        "gru_layers": 1,

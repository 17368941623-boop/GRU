...
def main() -> None:
    ...
    print(
        "SELECTION=Original_260501_validation_rapid_RMSE | "
    ...
    metadata = {
        "experiment": "Thv_h15_model_ablation_development_only",
    ...
    print(f"SECONDARY_FULL_VALIDATION_RMSE_K={validation_metrics['rmse_k']:.10f}")

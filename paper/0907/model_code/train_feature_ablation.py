#!/usr/bin/env python3
"""Train one Thv physical-feature ablation on train/validation only.
...
the separate evaluate_feature_test.py program is the only test reader.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train one leakage-safe Thv physical-feature ablation."
    )
...
def main() -> None:
    ...
    args.config_id = args.feature_set
    ...
    run_dir = run_directory(args.results_dir, spec, args.seed)
    ...
    metadata = {
        "experiment": "Thv_h15_lb60_physical_feature_ablation",
        ...
        "removed_feature_group": spec.get("removed_group"),
